...
var rep1 = ['<nom>thomas</nom><prénom>luc</prénom><email>luc.thomas@gmx.fr</email>',
            '<nom>bertrand</nom><prénom>jean</prénom><email>jean.bertrand@gmail.com</email>'];
var rep2 = ['<nom>bruno</nom><prénom>serge</prénom><email>serge.bruno@gmx.fr</email>',
            '<nom>simond</nom><prénom>paul</prénom><email>paul.simond@laposte.net</email>'];
var rep3 = ['<nom>bernard</nom><prénom>nicolas</prénom><email>nicolas.bernard@gmx.fr</email>',
            '<nom>sernant</nom><prénom>etienne</prénom><email>etienne.sernant@gmail.com</email>'];
var rep4 = ['<nom>marchand</nom><prénom>david</prénom><email>david.marchand@gmx.fr</email>',
            '<nom>legrand</nom><prénom>maxime</prénom><email>maxime.legrand@laposte.net</email>'];
...
function verif_exo(no)
{
    ...
    if (somme == no)
    {
        ...
        Vous pouvez passer à l'exercice suivant : <a class='abas' href='don_exercice3.4.html' > Exercice 3.4</a></span>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c4p3e3',1);
            fait();
        }
    }
    else
