var prop = 'marque,taille,nombredepages,carreauxclairefontaine,17x22,96,grandsoxford,24x32,48,petits';
...
function verif_exo(no)
{
    ...
    if (somme == no)
    {
        m.innerHTML="<span class='reponse_juste'> Toutes les réponses sont correctes ! Vous pouvez passer à l'exercice suivant : <a class='abas' href='don_exercice1.4.html' > Exercice 1.4</a></span>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c4p1e3',1);
            fait();
        }
    }
    else
