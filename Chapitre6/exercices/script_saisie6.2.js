...
function verif_exo(no)
{
    ...
    if (somme == no)
    {
        m.innerHTML="<span class='reponse_juste'> Toutes les réponses sont correctes ! Vous pouvez passer à l'exercice suivant : <a class='abas' href='SNT_GL_exercice6.3.html' > Exercice 6.3</a></span>";
    }
    else
    {
