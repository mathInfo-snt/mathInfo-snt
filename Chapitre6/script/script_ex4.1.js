prop = ['$GPGGL,4848.15,N,217.35,W,183942,A','$GPGGL,8919.85,S,10134.95,E,223755,A',
...
rep1 = ['18h39m42s','22h37m55s','17h41m38s','13h16m29s','15h56m44s','13h16m29s'];
rep2 = ["48°48'9\"n","89°19'51\"s","35°51'39\"s","58°26'27\"n","15°49'33\"s","71°26'51\"n"];
rep3 = ["2°17'21\"o","101°34'57\"e","94°28'15\"o","139°13'51\"e","104°31'15\"o","64°28'27\"e"];
...
function verif_exo(no)
{
    ...
    if (somme == no)
    {
        m.innerHTML="<span class='reponse_juste'> Toutes les réponses sont correctes ! Vous pouvez passer à l'exercice suivant : <a class='abas' href='gl_exercice4.2.html' > Exercice 4.2</a></span>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c6p4e1',1);
            fait();
        }
    }
    else
...
{
    cv1 = document.getElementById("conv1");
    ...
    cv2 = document.getElementById("conv2");
