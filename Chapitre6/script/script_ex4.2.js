prop = ["31°18'15\"Nord de latitude et 58°34'51\"Ouest de longitude",
...
rep1 = ['$GPGLL,3118.25,N,5834.85,W,163529,A',
...
function verif_exo(no)
{
    ...
    if (somme == no)
    {
        m.innerHTML="<span class='reponse_juste'> Toutes les réponses sont correctes ! Vous pouvez passer à l'exercice suivant : <a class='abas' href='gl_exercice4.3.html' > Exercice 4.3</a></span>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c6p4e2',1);
            fait();
        }
    }
    else
