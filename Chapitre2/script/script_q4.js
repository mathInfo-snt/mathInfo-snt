prop1 = ['"1" />un réseau','"0" />un protocole','"0" />un ordinateur','"0" />un routeur','"0" />un FAI','"0" />un port'];
prop2 = ['"1" />80','"0" />20','"0" />21','"0" />25','"0" />53','"0" />110'];
prop3 = ['"1" />204.66.224.82','"0" />199.7.55.3','"0" />1057','"0" />80','"0" />3:1057','"0" />82:80'];
prop4 = ['"1" />110','"0" />20','"0" />21','"0" />25','"0" />53','"0" />80'];
...
function verification(nb)
{
    ...
    if (somme==nb)
    {
        afrep.innerHTML="<span class='reponse_juste'>"+"Toutes les réponses sont correctes ! Vous pouvez passer à la suite : " 
                +"<a href=int_exercice4.1.html target='_blank'><b class='abas'>Exercice 4.1</b></a>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c2p4q4',1);
            fait();
        }
    }
    else
