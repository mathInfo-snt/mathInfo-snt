var lat = ["61° 27' 18\" Nord","58° 36' 27\" Sud","74° 6' 45\" Nord","19° 51' 54\" Sud",
            "4° 39' 9\" Nord","83° 51' 18\" Sud","46° 12' 45\" Nord","35° 15' 36\" Sud"];

var long = ["33° 21' 18\" Est","49° 39' 27\" Ouest","75° 9' 9\" Est","17° 57' 54\" Ouest",
            "156° 42' 36\" Est","114° 48' 18\" Ouest","172° 24' 45\" Est","137° 15' 54\" Ouest"];

var rep1 = ['61,455','-58,6075','74,1125','-19,865',
            '4,6525','-83,855','46,2125','-35,26'];
var rep2 = ['33,355','-49,6575','75,1525','-17,965',
...
function init1()
{
    var n = 2*Math.floor(Math.random() * 2) + i1%2;
    while ( n==nb1[0] || n==nb1[1] )
    {
        n = 2*Math.floor(Math.random() * 2) + i1%2;
    }
    i1=(i1+1)%2;
    nb1[i1]=n;
...
function verif_exo(no)
{
    ...
    if (somme == no)
    {
        ...
        +"<a class='abas' href='ima_exercice5.2.html' > Exercice 5.2</a></span>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c3p5e1',1);
            fait();
        }
    }
    else
