...
function verif_exo(no)
{
    ...
    if (somme == no)
    {
        m.innerHTML="<span class='reponse_juste'> Toutes les réponses sont correctes ! Vous pouvez passer à l'exercice suivant : <a class='abas' href='ima_exercice2.4.html' > Exercice 2.4</a></span>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c3p2e3',1);
            fait();
        }
    }
    else
