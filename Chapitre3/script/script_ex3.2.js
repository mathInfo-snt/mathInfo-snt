var prop = ['RVB(255,128,0)','RVB(64,128,255)','RVB(128,255,64)','RVB(128,64,32)'];
...
function verif_exo(no)
{
    ...
    if (somme == no)
    {
        m.innerHTML="<span class='reponse_juste'> Toutes les réponses sont correctes ! Vous pouvez passer à l'exercice suivant : <a class='abas' href='ima_exercice3.3.html' > Exercice 3.3</a></span>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c3p3e2',1);
            fait();
        }
    }
    else
