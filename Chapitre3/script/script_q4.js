prop1 = ['"1" />EXIF','"0" />EXT','"0" />RVB','"0" />IPTC','"0" />CCD','"0" />RGB','"0" />META','"0" />DATE'];
prop2 = ['"0" />EXIF','"0" />EXT','"0" />RVB','"1" />IPTC','"0" />CCD','"0" />RGB','"0" />META','"0" />DATE'];
prop3 = ['"0" />la marque de l\'appareil photo','"1" />les coordonnées GPS','"1" />les coordonnées de l\'auteur',
         '"0" />la date du cliché','"0" />le modèle de l\'appareil photo','"0" />la taille de l\'appareil photo',
         '"0" />la couleur de l\'appareil photo','"0" />l\'objectif de l\'appareil photo'];
...
function verification(nb)
{
    ...
    if (somme==nb)
    {
        afrep.innerHTML="<span class='reponse_juste'>"+"Toutes les réponses sont correctes ! Vous pouvez passer à la suite : " 
                +"<a href=ima_exercice4.1.html target='_blank'><b class='abas'>Exercice 4.1</b></a>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c3p4q4',1);
            fait();
        }
    }
    else
