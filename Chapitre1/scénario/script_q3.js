prop1 = ['"1" />www','"0" />com','"0" />de','"0" />fr','"0" />net','"0" />org'];
prop2 = ['"1" />ICANN','"0" />AFNIC','"0" />URL','"0" />FAI','"0" />CNIL','"0" />HTLM'];
prop3 = ['"1" />AFNIC','"0" />ICANN','"0" />URL','"0" />FAI','"0" />CNIL','"0" />HTLM'];
...
function verification(nb)
{
    ...
    if (somme==nb)
    {
        afrep.innerHTML="<span class='reponse_juste'>"+"Toutes les réponses sont correctes ! Vous pouvez passer à la suite : " 
                +"<a href=web_exercice3.1.html target='_blank'><b class='abas'>Exercice 3.1</b></a>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c1p3q3',1);
            fait();
        }
    }
    else
