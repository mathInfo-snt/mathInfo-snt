var tabrep = ["(page3,11)","(page2,9)","(page1,7)"];
...
function verif(nom_form,ind)
{
    ...
    else
    {
        ...
        sp2.innerHTML = "<span class='reponse_fausse'>  Mauvaise réponse !</span>";
    }
}
...
function verif_exo(no)
{
    ...
    if (somme == no)
    {
        m.innerHTML="<span class='reponse_juste'> Toutes les réponses sont correctes ! Vous pouvez passer à la page suivante : <a class='abas' href='web_exercice5.3.html' > Exercice 5.3 </a></span>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c1p5e2',1);
            fait();
        }
    }
    else
