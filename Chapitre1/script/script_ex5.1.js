...
function verif_exo(no)
{
    ...
    if (somme == no)
    {
        m.innerHTML="<span class='reponse_juste'> Toutes les réponses sont correctes ! Vous pouvez passer à l'exercice suivant : <a class='abas' href='web_exercice5.2.html' > Exercice 5.2 </a></span>";
        if(typeof localStorage!='undefined') 
        {
            localStorage.setItem('c1p5e1',1);
            fait();
        }
    }
    else
